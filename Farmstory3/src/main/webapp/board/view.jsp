...
<jsp:include page="./_aside${group}.jsp">
    ...
    <script>
    	$(document).ready(function(){
    		...
    		$('.btnCommentModify').click(function(){
    			...
    			if(mode == '수정'){
    				...
    				$.ajax({
    					url: '/Farmstory3/UpdateCommentService.do',
    					type: 'post',
        ...
        <section id="board" class="view">
            ...
            <div>
           		 <c:if test="${sessMember.uid eq vo.uid}">
	                ...
	                <a href="/Farmstory3/board/list.do?group=${group}&cate=${cate}&seq=${vo.seq}" class="btnList">목록</a>
            </div>  
